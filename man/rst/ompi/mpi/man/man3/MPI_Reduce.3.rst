...
.. seealso:: :ref:`MPI_Ireduce` :ref:`MPI_Op_create` :ref:`MPI_Op_free` :ref:`MPI_Allreduce` :ref:`MPI_Reduce_scatter` :ref:`MPI_Scan)` :ref:`MPI_Op_free)` :ref:`MPI_Scan` :ref:`MPI_Datatype` :ref:`MPI_Comm)` :ref:`MPI_Op` :ref:`MPI_Abort` :ref:`MPI_Comm_set_errhandler`
